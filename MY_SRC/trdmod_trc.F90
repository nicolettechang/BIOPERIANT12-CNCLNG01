...
!CD: split contribution of fluxes from the remainder of sms contribution
!         CASE ( jptra_trd_sms     )   ;   CALL trd_mld_trc_zint( ptrtrd, jpmld_trc_sms , '3D', kjn )
         CASE ( jptra_trd_bio     )   ;   CALL trd_mld_trc_zint( ptrtrd, jpmld_trc_bio , '3D', kjn )
         CASE ( jptra_trd_flx     )   ;   CALL trd_mld_trc_zint( ptrtrd, jpmld_trc_flx , '2D', kjn )
