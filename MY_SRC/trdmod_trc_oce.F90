...
!        jpmld_trc_atf     = 12        !:     asselin trend                    (** MUST BE    THE      LAST ONE**)
        jpmld_trc_bio     =  9,     & !:     sources minus sinks trend
        jpmld_trc_flx     = 10,     & !:     sources minus sinks trend
        jpmld_trc_radn    = 11,     & !:     corr. trn<0 in trcrad
        jpmld_trc_radb    = 12,     & !:     corr. trb<0 in trcrad (like atf) (** MUST BE BEFORE THE LAST ONE **)
        jpmld_trc_atf     = 13        !:     asselin trend                    (** MUST BE    THE      LAST ONE**)

   !! Trends diagnostics parameters
   !!---------------------------------------------------------------------
   INTEGER, PARAMETER :: jpltrd_trc = 13    !: number of mixed-layer trends arrays
