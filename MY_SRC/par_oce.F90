...
#elif defined key_orca_r05_l46
   !!---------------------------------------------------------------------
   !!   'key_orca_r05_l46'  :             global ocean : ORCA R05 46 level
   !!---------------------------------------------------------------------
#             include "par_ORCA_R05_L46.h90"
#elif defined key_orca_r025_l75
   !!---------------------------------------------------------------------
   !!   'key_orca_r025_l75' :                 global ocean : ORCA R025_L75
   !!---------------------------------------------------------------------
#             include "par_ORCA_R025_L75.h90"
#elif defined key_orca_r12
   !!---------------------------------------------------------------------
   !!   'key_orca_r12' :                         global ocean : ORCA R12
   !!---------------------------------------------------------------------
#             include "par_ORCA_R12_L46.h90"
...
#             include "par_PERIANT05.h90"
   ...
   !!---------------------------------------------------------------------
   !!   'key_periant12' :                      regional basin : PERIANT12
   !!---------------------------------------------------------------------
#             include "par_PERIANT12.h90"
#elif defined key_biosatlantic05
   !!---------------------------------------------------------------------
   !!   'key_biosatlantic05' :                      regional basin : BIOSATLANTIC05
   !!---------------------------------------------------------------------
#             include "par_BIOSATLANTIC05.h90"
#elif defined key_satlantic05
   !!---------------------------------------------------------------------
   !!   'key_satlantic05' :                      regional basin : SATLANTIC05
   !!---------------------------------------------------------------------
#             include "par_SATLANTIC05.h90"
#elif defined key_satlantic12
   !!---------------------------------------------------------------------
   !!   'key_satlantic12' :                      regional basin : SATLANTIC12
   !!---------------------------------------------------------------------
#             include "par_SATLANTIC12.h90"
#else
   !!---------------------------------------------------------------------
