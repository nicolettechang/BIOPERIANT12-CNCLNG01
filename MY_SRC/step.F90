...
# endif   
      ...
      IF( lk_obc_trc )   CALL obc_dta_trc( kstp )     ! update passive tracers at open boundaries
      IF( lk_obc     )   CALL obc_rad( kstp )         ! compute phase velocities at open boundaries
      IF( lk_obc_trc )   CALL obc_rad_trc( kstp )     ! compute at open boundaries
...
!}
      ...
      IF( lk_obc_trc       )   CALL obc_rst_write_trc( kstp )! write open boundary restart file
