...
# if defined key_obc_trc
   LOGICAL, PUBLIC, PARAMETER ::   lk_obc_trc = .TRUE.   !: Ocean Boundary Condition flag
#else
   LOGICAL, PUBLIC, PARAMETER ::   lk_obc_trc = .FALSE.  !: Ocean Boundary Condition flag
#endif
...
#elif defined key_periant12
   !!----------------------------------------------------------------------
   !!   'periant12' :                               PERIANT12 configuration
   !!----------------------------------------------------------------------
#    include "obc_par_PERIANT12.h90"
...
#elif defined key_biosatlantic05    
   !!----------------------------------------------------------------------    
   !!   'biosatlantic05' :                    BIOSATLANTIC05 configuration    
   !!---------------------------------------------------------------------- 
#    include "obc_par_BIOSATLANTIC05.h90"
#elif defined key_satlantic05    
   !!----------------------------------------------------------------------    
   !!   'satlantic05' :                    SATLANTIC05 configuration    
   !!---------------------------------------------------------------------- 
#    include "obc_par_SATLANTIC05.h90"
#elif defined key_satlantic12 
   !!----------------------------------------------------------------------    
   !!   'satlantic12' :                    SATLANTIC12 configuration    
   !!---------------------------------------------------------------------- 
#    include "obc_par_SATLANTIC12.h90"
# else
   !!---------------------------------------------------------------------
...
#if defined key_obc_trc
   LOGICAL, PARAMETER ::   lp_obc_east_trc = .FALSE. !: to active or not the East open boundary for passive tracers
#endif
   INTEGER   &
#if !defined key_agrif
     , PARAMETER   & 
...
#if defined key_obc_trc
   LOGICAL, PARAMETER ::   lp_obc_west_trc = .FALSE. !: to active or not the East open boundary for passive tracers
#endif
   INTEGER   &
#if !defined key_agrif
     , PARAMETER   & 
...
#if defined key_obc_trc
   LOGICAL, PARAMETER ::   lp_obc_north_trc = .FALSE. !: to active or not the East open boundary for passive tracers
#endif
     INTEGER   &
#if !defined key_agrif
     , PARAMETER   & 
...
#if defined key_obc_trc
   LOGICAL, PARAMETER ::   lp_obc_south_trc = .FALSE. !: to active or not the East open boundary for passive tracers
#endif
     INTEGER   &
#if !defined key_agrif
     , PARAMETER   & 
...
# endif
   ...
   LOGICAL, PUBLIC            ::   lk_obc_trc = .FALSE.     !: Ocean Boundary Condition flag
#endif
#endif
