...
!   INTEGER, PUBLIC, PARAMETER ::   jptra_trd_sms  = 13    !: sources m. sinks
   INTEGER, PUBLIC, PARAMETER ::   jptra_trd_bio  = 13    !: sources m. sinks
   INTEGER, PUBLIC, PARAMETER ::   jptra_trd_flx  = 14    !: sources m. sinks
   INTEGER, PUBLIC, PARAMETER ::   jptra_trd_radn = 15    !: corr. trn<0 in trcrad
   INTEGER, PUBLIC, PARAMETER ::   jptra_trd_radb = 16    !: corr. trb<0 in trcrad (like atf)
#endif
